...
export const SOCKET_READY = 'sockets/READY'; // connection events
...
export const RECONNECT_FAILED = 'connections/RECONNECT_FAILED'; // messages
...
export const connectError = function connectError({
  error
}) {
  return {
    error,
...
export const connectTimeout = function connectTimeout({
  timeout
}) {
  return {
...
export const reconnectError = function reconnectError({
  error
}) {
  return {
    error,
...
export const socketConnect = function socketConnect({
  socket
}) {
  return {
    type: CONNECT,
