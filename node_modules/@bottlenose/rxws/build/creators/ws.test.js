...
function stubActions() {
  return {
    ...
    socketConnect: sinon.stub().returns({
      type: 'CONNECT'
    }),
    disconnect: sinon.stub().returns({
      type: 'DISCONNECT'
    }),
    socketError: sinon.stub().returns({
      type: 'SOCKET_ERR'
    }),
    newMessage: sinon.stub().returns({
      type: 'NEW_MESSAGE'
    })
  };
}

describe('ws', () => {// it('should react to websocket events correctly and stop$ when sent stop$ event', done => {
